...
namespace Corona.View
{
    public partial class Info : Form
    {
        ...
        {
            //List<string> title = DBConnection.GuestTitile();
            //List<string> country = DBConnection.GuestCountry();

            //foreach (var item in title)
            //{
            //    ttlLblDrop.Items.Add(item);
            //} 
            //foreach (var item in country)
            //{
            //    ctryLblDrop.Items.Add(item);
            //}
            ...
            List<Title> passTitle = new List<Title>();
            ...
            while (DR1.Read())
            {
                Title gt = new Title(DR1.GetString(0), DR1.GetInt32(1));
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Title hotel = (Title)ttlLblDrop.SelectedItem;
