...
namespace CinnamonCare.View
{
    public  partial class Login : Form
    {
        ...
        {
            /// DBConnection db = new DBConnection(phnLblTxt.Text);
            ...
            //if (tblLblTxt.Text.Length!=0 || re.IsMatch(tblLblTxt.Text))
            //{
            //    Info inf = new Info(GPhone, tblLblTxt.Text, htlLblDrop.Text);
            //    inf.Show();
            //    this.Hide();
            //    if (htlLblDrop.SelectedIndex !=-1)
            //    {
            ...
            //else 
            //{
            //    MessageBox.Show("Table Number is invalid");
            //}
